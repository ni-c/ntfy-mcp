...
const site = 'https://ntfy-mcp.ni-c.de';
const description =
...
export default defineConfig({
  ...
  head: [
    ...
    // and correct by hand.
    //
    // No `link rel=icon` and no `og:image` yet: this site ships no favicon.svg and
    // no og.png, and a head entry pointing at a file that does not exist is a 404
    // on every page and a broken preview card everywhere the URL is unfurled. Add
    // both here in the same commit that adds the files.
    ['meta', { name: 'theme-color', content: '#4f46e5' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:site_name', content: 'ntfy-mcp' }],
    ['meta', { property: 'og:title', content: 'ntfy-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/tools', activeMatch: '/reference/' },
      {
        ...
        items: [
          ...
          { text: 'Releases', link: 'https://github.com/ni-c/ntfy-mcp/releases' },
          { text: 'npm package', link: 'https://www.npmjs.com/package/@ni-c/ntfy-mcp' },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is ntfy-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/ntfy-mcp' },
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/ntfy-mcp/edit/main/docs/:path',
